...
# Define input files ------------------------------------------------
vcffileALL <- "/nesi/nobackup/uoa02613/kstuart_projects/Sv10_NZstarlings/analysis/A_SFS/data/filtered_VCF/starling_noduprel_qual_miss_filt_bial_thin50kb.vcf.gz"
...
metadtfile <- "/nesi/nobackup/uoa02613/kstuart_projects/Sv10_NZstarlings/analysis/A_SFS/data/Metadata_NZ_AU_UK_BE_ReplicatesSibRemoved2.csv"
...
save(sfsdt, file = "data/SFS_ALL_thin50kb_100_iterations_indmin10.Rdata")
...
## Figure 6 ---------------------------------------------------------
pdf("results/SFS_ALL_thin50kb.pdf", width = 8.3, height = 3.5)
sfsdt$median_quantile_plot_nLoc + 
  facet_grid(.~popn) +
  ...
  ggtitle("SFS plot, 9362 SNPs, subset n = 10, 100 iterations")
dev.off()
