...
# Define input files ------------------------------------------------
vcffileALL <- "data/filtered_VCF/starling_noduprel_qual_miss_filt_bial_nomissingness.vcf.gz"
...
# save(sfsdt, file = "data/SFS_nomissingness_nothin_100_iterations_indmin10.Rdata")
load("data/SFS_nomissingness_nothin_100_iterations_indmin10.Rdata")
# Define colours ----------------------------------------------------
lab_order <- poporder
...
## Figure 6 ---------------------------------------------------------
pdf("results/SFS_nomissing_nothin.pdf", width = 8.3, height = 3.5)
sfsdt$median_quantile_plot_nLoc + 
  facet_grid(.~popn) +
  ...
  ggtitle("SFS plot, 1451 SNPs, subset n = 10, 100 iterations")
dev.off()
