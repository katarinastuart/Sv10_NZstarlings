...
# with no missingness and thinned
#
...
# Define input files ------------------------------------------------
vcffileALL <- "data/filtered_VCF/starling_noduprel_qual_miss_filt_bial_nomissingness_thin50kb.vcf.gz"
...
# save(sfsdt, file = "data/SFS_nomissingness_thin50kb_100_iterations_indmin10.Rdata")
load("data/SFS_nomissingness_thin50kb_100_iterations_indmin10.Rdata")
...
## Figure 6 ---------------------------------------------------------
pdf("results/SFS_nomissing_thin50kb.pdf", width = 8.3, height = 3.5)
sfsdt$median_quantile_plot_nLoc + 
  facet_grid(.~popn) +
  ...
  ggtitle("SFS plot, 1334 SNPs, subset n = 10, 100 iterations")
dev.off()
